        ...
        {shouldLoad ? (
          <>
            <img
              ...
              className={`w-full h-full object-cover rounded-lg shadow transition-opacity duration-300 ${
                hasLoaded ? 'opacity-100' : 'opacity-0'
              }`}
              style={{ display: 'block', margin: 'auto', pointerEvents: 'none', objectFit: 'cover' }}
