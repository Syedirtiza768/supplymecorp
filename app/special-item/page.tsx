  ...
  return (
    <div className="container py-8">
      <div className="mb-6 flex items-center gap-2 text-sm text-muted-foreground">
        ...
        <span className="font-medium text-foreground">Need a Special Item?</span>
      </div>

      <div className="mb-8">
        <h1 className="text-3xl font-bold">Need a Special Item?</h1>
        <p className="mt-2 text-muted-foreground">
          Can't find what you're looking for? We can help source special items for your project needs.
        </p>
      </div>
      ...
      <div className="grid gap-8 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Fill out the form below with as much detail as possible about the item you need.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form className="grid gap-4">
              ...
              <Button type="submit" className="mt-2 bg-primary hover:bg-primary-700">
                Submit Request
              </Button>
            </form>
          </CardContent>
        ...
        <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Fill out the form with as much detail as possible about the item you need.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Our team will research availability, pricing, and delivery options for your item.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    We'll provide you with pricing and availability information within 1-2 business days.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Once you approve the quote, we'll place the order and keep you updated on delivery.
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Prefer to speak with someone directly? Contact our special orders department.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    <a href="mailto:specialorders@rrgeneralsupply.com" className="hover:text-primary">
